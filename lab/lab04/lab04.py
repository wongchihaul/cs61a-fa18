...
def distance(city1, city2):
    ...
    """
    "*** YOUR CODE HERE ***"
#    coor1 = [get_lat(city1), get_lon(city1)]
#    coor2 = [get_lat(city2), get_lon(city2)]
...
#    coor1 = [get_lat(city1), get_lon(city1)]
#    coor2 = [get_lat(city2), get_lon(city2)]
    destination = make_city(' ',lat,lon)
    if distance(destination,city1)>distance(destination,city2):
